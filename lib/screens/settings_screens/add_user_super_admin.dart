...
class _AddUserSuperAdminState extends State<AddUserSuperAdmin> {
  ...
  String? currentSchoolAbbr;
  String? currentSchoolAddress;
    ...
    try {
      await FirebaseFirestore.instance
        ...
        for (var doc in querySnapshot.docs) {
          setState(() {
            schoolsList.add({'id': doc.id, 'name': doc['name'], 'abbreviation': doc['abbreviation'], 'address': doc['address']});
          });
        }
        ...
        if (schoolsList.isNotEmpty) {
          ...
          currentSchoolAbbr = schoolsList[0]['abbreviation'];
          currentSchoolAddress = schoolsList[0]['address'];
        } else {
                          ...
                          DropdownButton(
                            ...
                            onChanged: (String? newValue) {
                              setState(() {
                                ...
                                currentSchoolAbbr = schoolsList.firstWhere((school) => school['id'] == newValue)['abbreviation'];
                                currentSchoolAddress = schoolsList.firstWhere((school) => school['id'] == newValue)['address'];
                              });
                            },
                          )
                        ],
